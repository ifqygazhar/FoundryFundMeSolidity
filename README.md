...
Learn course Web3 from Patrick big thanks to [Patrick Collins](https://github.com/PatrickAlphaC) for the original Foundry Fund Me project.
...
```
git clone https://github.com/ifqygazhar/FoundryFundMeSolidity
cd FoundryFundMeSolidity
make
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/ifqygazhar/FoundryFundMeSolidity)
